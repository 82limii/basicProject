...
public class ReservationDAO {
	...
	public int insertReserve(ReservationVO vo, String memId) {
		return template.update("INSERT INTO RESERVARTION(res_no, RES_DATE, RES_IN_DATE, RES_OUT_DATE, MEM_ID, ROOM_ID) VALUES(replace(to_char(sysdate,'YYYYMMDD')||to_char(seq_res_no.nextval,'0000'), sysdate,?,?,?,?)"
